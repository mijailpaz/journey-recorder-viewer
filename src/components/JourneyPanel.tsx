              ...
              <>
                ...
                {onAddFilter && filterGroups && (
                  <button
                    ...
                    aria-label={event.kind === 'request' ? 'Add domain to filter' : 'Filtering only available for requests'}
                    title={event.kind === 'request' ? 'Add domain to filter' : 'Filtering only available for requests'}
        ...
        <div className="px-6 py-5 space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Regex pattern to match request URLs. Original domain: <code className="text-gray-400">{domain || 'none'}</code>
            </p>
          </div>
